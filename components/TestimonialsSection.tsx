...
export default function TestimonialsSection() {
  ...
  // Pausa a animação horizontal sempre que o usuário estiver rolando a página verticalmente
  useEffect(() => {
  ...
  // Eventos de toque (mobile) — permite rolagem vertical nativa sem travar a tela
    ...
    >
      ...
      <div className="w-full relative py-2">
        ...
        <div
          ...
          className={`flex items-center gap-4 sm:gap-6 px-4 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden [touch-action:pan-x_pan-y] select-none ${
